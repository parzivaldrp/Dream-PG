...
function Categories({ onSubmit }) {
  ...
  const handleSubmit = (event) => {
    ...
    console.log("Submitted Data:", { whoCanStay: categories, idealFor: idealFor, budgetRange: budget });
    onSubmit({ whoCanStay: categories,  // Use 'whoCanStay' here
    idealFor: idealFor, 
    budgetRange: budget  });
  };
